...
abstract contract SolPerpMarketCreditConfig {
    ...
    address internal constant SOL_PERP_MARKET_CREDIT_CONFIG_ENGINE = address(0x7);
    address internal constant SOL_PERP_MARKET_CREDIT_CONFIG_ENGINE_USD_TOKEN = address(0x7);
