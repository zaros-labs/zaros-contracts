...
abstract contract MaticPerpMarketCreditConfig {
    ...
    // Arbitrum Sepolia
    address internal constant MATIC_ARB_SEPOLIA_PERP_MARKET_CREDIT_CONFIG_ENGINE = address(0x4);
    address internal constant MATIC_ARB_SEPOLIA_PERP_MARKET_CREDIT_CONFIG_ENGINE_USD_TOKEN = address(0x4);

    // Monad Testnet
    address internal constant MATIC_MONAD_TESTNET_PERP_MARKET_CREDIT_CONFIG_ENGINE =
        address(0x6D90B34da7e2AdCB07FDf096242875ff7941eC74);
    address internal constant MATIC_MONAD_TESTNET_PERP_MARKET_CREDIT_CONFIG_ENGINE_USD_TOKEN =
