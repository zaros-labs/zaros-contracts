...
abstract contract BnbPerpMarketCreditConfig {
    ...
    // Arbitrum Sepolia
    address internal constant BNB_ARB_SEPOLIA_PERP_MARKET_CREDIT_CONFIG_ENGINE = address(0x4);
    address internal constant BNB_ARB_SEPOLIA_PERP_MARKET_CREDIT_CONFIG_ENGINE_USD_TOKEN = address(0x4);
