...
abstract contract WBtc {
    ...
    uint256 internal constant WBTC_MARKET_MAKING_ENGINE_COLLATERAL_ID = 2;
    address internal constant WBTC_MARKET_MAKING_ENGINE_ADDRESS = address(0x2);
    ...
    // Monad Testnet
    address internal constant WBTC_MONAD_TESTNET_MARKET_MAKING_ENGINE_PRICE_ADAPTER = address(0x2);
}
