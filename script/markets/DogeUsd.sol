...
abstract contract DogeUsd {
    /// @notice DOGE/USD market configuration parameters.
    uint128 internal constant DOGE_USD_MARKET_ID = 6;
    string internal constant DOGE_USD_MARKET_NAME = "DOGE/USD Perpetual";
    string internal constant DOGE_USD_MARKET_SYMBOL = "DOGE/USD-PERP";
    ...
    uint256 internal constant MOCK_DOGE_USD_PRICE = 600e18;
