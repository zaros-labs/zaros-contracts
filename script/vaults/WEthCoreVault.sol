...
abstract contract WEthCoreVault {
    ...
    address internal constant WETH_MONAD_TESTNET_CORE_VAULT_ENGINE = address(0); // the address will be updated in the
        // mainnet
    address internal constant WETH_MONAD_TESTNET_CORE_VAULT_ASSET = address(0);
    address internal constant WETH_MONAD_TESTNET_CORE_VAULT_PRICE_ADAPTER = address(0);
}
