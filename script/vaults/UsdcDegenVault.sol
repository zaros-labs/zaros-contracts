...
abstract contract UsdcDegenVault {
    ...
    // Monad Testnet
    address internal constant USDC_MONAD_TESTNET_DEGEN_VAULT_ENGINE = address(0); // the address will be updated in
        // the mainnet
    address internal constant USDC_MONAD_TESTNET_DEGEN_VAULT_ASSET = address(0);
    address internal constant USDC_MONAD_TESTNET_DEGEN_VAULT_PRICE_ADAPTER = address(0);
}
