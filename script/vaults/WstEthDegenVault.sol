...
abstract contract WstEthDegenVault {
    ...
    uint128 internal constant WSTETH_DEGEN_VAULT_DEPOSIT_CAP = 1_000_000_000e18;
    ...
    uint256 internal constant WSTETH_DEGEN_VAULT_CREDIT_RATIO = 1e18;
    ...
    // Arbitrum Sepolia
    address internal constant WSTETH_ARB_SEPOLIA_DEGEN_VAULT_ENGINE = address(0); // the address will be updated in
        // the mainnet
    address internal constant WSTETH_ARB_SEPOLIA_DEGEN_VAULT_ASSET = address(0);
    address internal constant WSTETH_ARB_SEPOLIA_DEGEN_VAULT_PRICE_ADAPTER = address(0);

    // Monad Testnet
    address internal constant WSTETH_MONAD_TESTNET_DEGEN_VAULT_ENGINE =
        address(0x6D90B34da7e2AdCB07FDf096242875ff7941eC74); // the address will be updated in
        // the mainnet
    address internal constant WSTETH_MONAD_TESTNET_DEGEN_VAULT_ASSET = address(0);
    address internal constant WSTETH_MONAD_TESTNET_DEGEN_VAULT_PRICE_ADAPTER =
