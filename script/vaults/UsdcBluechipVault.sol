...
abstract contract UsdcBluechipVault {
    ...
    uint128 internal constant USDC_BLUECHIP_VAULT_DEPOSIT_CAP = 1_000_000_000e18;
    ...
    uint256 internal constant USDC_BLUECHIP_VAULT_CREDIT_RATIO = 1e18;
    ...
    // Arbitrum Sepolia
    address internal constant USDC_ARB_SEPOLIA_BLUECHIP_VAULT_ENGINE = address(0); // the address will be updated in
        // the mainnet
    address internal constant USDC_ARB_SEPOLIA_BLUECHIP_VAULT_ASSET = address(0);
    address internal constant USDC_ARB_SEPOLIA_BLUECHIP_VAULT_PRICE_ADAPTER = address(0);

    // Monad Testnet
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_ENGINE =
        address(0x6D90B34da7e2AdCB07FDf096242875ff7941eC74); // the address will be updated in
        // the mainnet
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_ASSET =
        address(0x3Bb8a17d8EDCAAbC0E064500367Efc89f90A6D83);
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_PRICE_ADAPTER =
