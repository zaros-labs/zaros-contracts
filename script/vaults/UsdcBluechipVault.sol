...
abstract contract UsdcBluechipVault {
    ...
    // Monad Testnet
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_ENGINE = address(0); // the address will be updated in
        // the mainnet
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_ASSET = address(0);
    address internal constant USDC_MONAD_TESTNET_BLUECHIP_VAULT_PRICE_ADAPTER = address(0);
}
