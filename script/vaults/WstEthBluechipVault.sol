...
abstract contract WstEthBluechipVault {
    ...
    // Arbitrum Sepolia
    address internal constant WSTETH_ARB_SEPOLIA_BLUECHIP_VAULT_ENGINE = address(0); // the address will be updated in
        // the mainnet
    address internal constant WSTETH_ARB_SEPOLIA_BLUECHIP_VAULT_ASSET = address(0);
    address internal constant WSTETH_ARB_SEPOLIA_BLUECHIP_VAULT_PRICE_ADAPTER = address(0);

    // Monad Testnet
    address internal constant WSTETH_MONAD_TESTNET_BLUECHIP_VAULT_ENGINE = address(0); // the address will be updated
        // in the mainnet
    address internal constant WSTETH_MONAD_TESTNET_BLUECHIP_VAULT_ASSET = address(0);
    address internal constant WSTETH_MONAD_TESTNET_BLUECHIP_VAULT_PRICE_ADAPTER = address(0);
}
