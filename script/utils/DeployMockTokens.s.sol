...
contract DeployMockTokens is BaseScript {
    function run() public broadcaster returns (MockERC20, MockERC20, MockUSDToken) {
        MockERC20 sFrxEth =
        new MockERC20({ name: "Staked Frax Ether", symbol: "sfrxETH", decimals_: 18, owner: deployer, ownerBalance: 1_000_000_000e18 });
        MockERC20 usdc =
        new MockERC20({ name: "USD Coin", symbol: "USDC", decimals_: 6, owner: deployer,  ownerBalance: 1_000_000_000e6 });
