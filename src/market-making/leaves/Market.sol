...
library Market {
    ...
    function getRealizedDebtUsd(Data storage self) internal view returns (SD59x18 realizedDebtUsdX18) {
        ...
        // finally after determining the market's latest credit deposits usd value, sub it from the stored net usd
        ...
        )
    {
        ...
        wethRewardChangeX18 = ud60x18(self.wethRewardPerVaultShare).sub(lastVaultDistributedWethRewardPerShareX18).mul(wethRewardChangeX18);
    }
