...
contract GetAccountMarginCollateralBalance_Integration_Test is Base_Integration_Shared_Test {
    ...
    function testFuzz_GetAccountMarginCollateralConfiguration(uint256 amountToDeposit) external {
        ...
        assertEq(marginCollateralAmount, amountToDeposit, "getAccountMarginCollateralConfiguration");
    }
}
